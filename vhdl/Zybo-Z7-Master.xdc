...
##Switches
set_property -dict { PACKAGE_PIN G15   IOSTANDARD LVCMOS33 } [get_ports { ctl }]; #IO_L19N_T3_VREF_35 Sch=sw[0]
...
##Buttons
set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { ext_reset_in }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
