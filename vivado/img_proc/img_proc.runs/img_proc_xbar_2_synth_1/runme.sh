...
HD_PWD='/home/austin/Desktop/projects/zybo/zybo_img_proc/vivado/img_proc/img_proc.runs/img_proc_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log img_proc_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source img_proc_xbar_2.tcl
