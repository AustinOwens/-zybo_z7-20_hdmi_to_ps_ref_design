...
architecture STRUCTURE of img_proc is
  ...
  component img_proc_clk_wiz_0_0 is
  port (
    reset : in STD_LOGIC;
  ...
  end component img_proc_clk_wiz_0_0;
  component img_proc_xlconstant_0_0 is
  port (
    dout : out STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component img_proc_xlconstant_0_0;
  ...
  attribute X_INTERFACE_PARAMETER of sys_clock : signal is "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN img_proc_sys_clock, FREQ_HZ 125000000, INSERT_VIP 0, PHASE 0.000";
...
clk_wiz_0: component img_proc_clk_wiz_0_0
     port map (
      clk_in1 => sys_clock_1,
...
xlconstant_0: component img_proc_xlconstant_0_0
     port map (
