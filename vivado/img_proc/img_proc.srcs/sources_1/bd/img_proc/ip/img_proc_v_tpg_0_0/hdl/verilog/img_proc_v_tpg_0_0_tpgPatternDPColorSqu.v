...
module img_proc_v_tpg_0_0_tpgPatternDPColorSqu (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [0:0] or_ln1701_reg_739;
reg   [0:0] or_ln1701_reg_739_pp0_iter1_reg;
reg   [0:0] or_ln1701_reg_739_pp0_iter2_reg;
...
wire   [7:0] select_ln300_3_fu_574_p3;
wire   [7:0] select_ln1706_fu_609_p3;
wire  signed [7:0] sext_ln1694_fu_594_p1;
wire   [7:0] select_ln1687_fu_616_p3;
wire   [7:0] select_ln1701_fu_602_p3;
wire   [7:0] select_ln1687_1_fu_623_p3;
wire  signed [7:0] sext_ln1693_fu_590_p1;
wire   [7:0] select_ln300_fu_566_p3;
wire   [0:0] or_ln1699_fu_644_p2;
wire   [7:0] select_ln1699_1_fu_637_p3;
wire   [7:0] select_ln1699_2_fu_648_p3;
wire  signed [7:0] sext_ln1695_fu_598_p1;
wire   [7:0] select_ln300_4_fu_582_p3;
wire   [7:0] select_ln1699_4_fu_663_p3;
wire   [7:0] select_ln1699_5_fu_670_p3;
wire   [7:0] select_ln1699_3_fu_655_p3;
wire   [7:0] select_ln1699_fu_630_p3;
wire   [7:0] select_ln1699_6_fu_677_p3;
reg   [0:0] ap_NS_fsm;
...
img_proc_v_tpg_0_0_tpgPatternDPColorbkb #(
    .DataWidth( 3 ),
    .AddressRange( 16 ),
    .AddressWidth( 4 ))
DPtpgBarArray_U(
...
img_proc_v_tpg_0_0_tpgPatternDPColorcud #(
    .DataWidth( 1 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColordEe #(
    .DataWidth( 1 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColoreOg #(
    .DataWidth( 1 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorfYi #(
    .DataWidth( 6 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorg8j #(
    .DataWidth( 6 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorhbi #(
    .DataWidth( 6 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColoribs #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorjbC #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorkbM #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorlbW #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColormb6 #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
img_proc_v_tpg_0_0_tpgPatternDPColorncg #(
    .DataWidth( 8 ),
    .AddressRange( 8 ),
    .AddressWidth( 3 ))
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        or_ln1701_reg_739 <= or_ln1701_fu_483_p2;
        or_ln1701_reg_739_pp0_iter1_reg <= or_ln1701_reg_739;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        or_ln1701_reg_739_pp0_iter2_reg <= or_ln1701_reg_739_pp0_iter1_reg;
    end
end
...
always @ (*) begin
    ap_condition_183 = ((1'd0 == and_ln1657_fu_351_p2) & (icmp_ln1652_fu_325_p2 == 1'd0) & (icmp_ln1657_fu_345_p2 == 1'd1));
end

always @ (*) begin
    ap_condition_56 = ((1'b1 == ap_ce) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0));
end
...
assign ap_return_0 = select_ln1699_3_fu_655_p3;

assign ap_return_1 = select_ln1699_fu_630_p3;

assign ap_return_2 = select_ln1699_6_fu_677_p3;
...
assign or_ln1699_fu_644_p2 = (and_ln1699_fu_519_p2 | and_ln1687_fu_507_p2);
...
assign select_ln1687_1_fu_623_p3 = ((and_ln1687_fu_507_p2[0:0] === 1'b1) ? sext_ln1694_fu_594_p1 : select_ln1687_fu_616_p3);

assign select_ln1687_fu_616_p3 = ((icmp_ln1687_fu_495_p2[0:0] === 1'b1) ? select_ln300_3_fu_574_p3 : select_ln1706_fu_609_p3);

assign select_ln1699_1_fu_637_p3 = ((and_ln1699_fu_519_p2[0:0] === 1'b1) ? DPtpgBarSelYuv_601_y_q0 : sext_ln1693_fu_590_p1);

assign select_ln1699_2_fu_648_p3 = ((icmp_ln1687_fu_495_p2[0:0] === 1'b1) ? select_ln300_fu_566_p3 : DPtpgBarSelYuv_709_y_q0);

assign select_ln1699_3_fu_655_p3 = ((or_ln1699_fu_644_p2[0:0] === 1'b1) ? select_ln1699_1_fu_637_p3 : select_ln1699_2_fu_648_p3);

assign select_ln1699_4_fu_663_p3 = ((and_ln1699_fu_519_p2[0:0] === 1'b1) ? DPtpgBarSelYuv_601_v_q0 : sext_ln1695_fu_598_p1);

assign select_ln1699_5_fu_670_p3 = ((icmp_ln1687_fu_495_p2[0:0] === 1'b1) ? select_ln300_4_fu_582_p3 : DPtpgBarSelYuv_709_v_q0);

assign select_ln1699_6_fu_677_p3 = ((or_ln1699_fu_644_p2[0:0] === 1'b1) ? select_ln1699_4_fu_663_p3 : select_ln1699_5_fu_670_p3);

assign select_ln1699_fu_630_p3 = ((and_ln1699_fu_519_p2[0:0] === 1'b1) ? select_ln1701_fu_602_p3 : select_ln1687_1_fu_623_p3);

assign select_ln1701_fu_602_p3 = ((or_ln1701_reg_739_pp0_iter2_reg[0:0] === 1'b1) ? DPtpgBarSelYuv_601_u_q0 : DPtpgBarSelYuv_601_v_q0);

assign select_ln1706_fu_609_p3 = ((or_ln1701_reg_739_pp0_iter2_reg[0:0] === 1'b1) ? DPtpgBarSelYuv_709_u_q0 : DPtpgBarSelYuv_709_v_q0);

assign select_ln300_3_fu_574_p3 = ((DPtpgBarSelRgb_VESA_2_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign select_ln300_4_fu_582_p3 = ((DPtpgBarSelRgb_VESA_1_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign select_ln300_fu_566_p3 = ((DPtpgBarSelRgb_VESA_s_q0[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign sext_ln1693_fu_590_p1 = $signed(DPtpgBarSelRgb_CEA_r_q0);

assign sext_ln1694_fu_594_p1 = $signed(DPtpgBarSelRgb_CEA_g_q0);

assign sext_ln1695_fu_598_p1 = $signed(DPtpgBarSelRgb_CEA_b_q0);
...
assign zext_ln1688_1_fu_550_p1 = DPtpgBarArray_q0;

assign zext_ln1688_fu_545_p1 = tmp_2_fu_537_p3;

endmodule //img_proc_v_tpg_0_0_tpgPatternDPColorSqu
