...
--Date        : Sun Nov  3 15:46:47 2019
--Host        : austin-ubuntu running 64-bit Ubuntu 18.04.3 LTS
--Command     : generate_target img_proc_baseline_wrapper.bd
...
entity img_proc_baseline_wrapper is
  port (
...
end img_proc_baseline_wrapper;

architecture STRUCTURE of img_proc_baseline_wrapper is
  component img_proc_baseline is
  port (
    hdmi_in_clk_p : in STD_LOGIC;
    hdmi_in_clk_n : in STD_LOGIC;
    hdmi_in_data_p : in STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  end component img_proc_baseline;
  component IOBUF is
  port (
    I : in STD_LOGIC;
    O : out STD_LOGIC;
...
img_proc_baseline_i: component img_proc_baseline
     port map (
